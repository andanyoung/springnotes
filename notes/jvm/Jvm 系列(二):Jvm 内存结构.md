...
![](https://imgconvert.csdnimg.cn/aHR0cDovL2Zhdm9yaXRlcy5yZW4vYXNzZXRzL2ltYWdlcy8yMDE3L2p2bS9qdm0wMy5wbmc?x-oss-process=image/format,png)
...
![](https://imgconvert.csdnimg.cn/aHR0cDovL2Zhdm9yaXRlcy5yZW4vYXNzZXRzL2ltYWdlcy8yMDE3L2p2bS9qdm0wNC5wbmc?x-oss-process=image/format,png)
...
![](https://imgconvert.csdnimg.cn/aHR0cDovL2Zhdm9yaXRlcy5yZW4vYXNzZXRzL2ltYWdlcy8yMDE3L2p2bS9qdm0wNS5wbmc?x-oss-process=image/format,png)
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-wU4VxUya-1580960730007)(http://ifeve.com/wp-content/uploads/2015/05/JUtH_20121024_RuntimeDataAreas_2_MemoryModel-1.png)]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-QSlQbvQg-1580960730009)(http://ifeve.com/wp-content/uploads/2015/05/JUtH_20121024_RuntimeDataAreas_4_MemoryModel.png)]

通过JConsole工具可以查看运行中的Java程序（比如Eclipse）的一些信息：堆内存的分配，线程的数量以及加载的类的个数；

![](https://imgconvert.csdnimg.cn/aHR0cDovL2lmZXZlLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNS9KVXRIXzIwMTIxMDI0X1J1bnRpbWVEYXRhQXJlYXNfNV9KQ29uc29sZS5wbmc?x-oss-process=image/format,png)
